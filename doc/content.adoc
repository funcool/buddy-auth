...
All built-in backends already implement the autorization protocol with default behavior. The
default behavior can be overridden passing the `:unauthorized-handler` option to the backend
constructor:
